        ...
        instances: [
            ...
            },
            {
                ...
                properties: {
                    Name: 'CanopyBridge',
                    Size: [3.2, 2.1, 2.4],
                    Position: offsetPosition(pos, -1.1, 10.6, 0.7),
                    Color: blendColor([50, 124, 46], 10),
                    Anchored: true,
                    Material: leaf,
                    Shape: 'Block',
                    CFrame: { position: offsetPosition(pos, -1.1, 10.6, 0.7), rotation: [0, rot + 18, 0] },
                },
            },
            {
                // Upper canopy
            ...
            },
            {
                ...
                properties: {
                    Name: 'BranchStub',
                    Size: [0.45, 1.6, 0.45],
                    Position: offsetPosition(pos, -0.65, 8.2, 0.55),
                    Color: [78, 52, 32],
                    Anchored: true,
                    Material: 'Wood',
                    Shape: 'Cylinder',
                    CFrame: { position: offsetPosition(pos, -0.65, 8.2, 0.55), rotation: [0, rot + 35, 68] },
                },
            },
        ],
        terrain: [],
        ...
        instances: [
            ...
            },
            {
                ...
                properties: {
                    Name: 'CanopyBridgeA',
                    Size: [4.4, 2.7, 3.2],
                    Position: offsetPosition(pos, -2.1, 14.2, 1.2),
                    Color: blendColor([52, 126, 46], 10),
                    Anchored: true,
                    Material: leaf,
                    Shape: 'Block',
                    CFrame: { position: offsetPosition(pos, -2.1, 14.2, 1.2), rotation: [0, rot + 22, 0] },
                },
            },
            {
                className: 'Part',
                ...
                properties: {
                    Name: 'CanopyBridgeB',
                    Size: [3.6, 2.2, 2.9],
                    Position: offsetPosition(pos, 2.2, 15.4, -0.8),
                    Color: blendColor([60, 136, 50], 10),
                    Anchored: true,
                    Material: leaf,
                    Shape: 'Block',
                    CFrame: { position: offsetPosition(pos, 2.2, 15.4, -0.8), rotation: [0, rot - 18, 0] },
                },
            },
            {
                className: 'Part',
            ...
            },
            {
                ...
                properties: {
                    Name: 'BranchA',
                    Size: [0.5, 2.2, 0.5],
                    Position: offsetPosition(pos, -1.1, 10.2, 0.8),
                    Color: [70, 48, 30],
                    Anchored: true,
                    Material: 'Wood',
                    Shape: 'Cylinder',
                    CFrame: { position: offsetPosition(pos, -1.1, 10.2, 0.8), rotation: [0, rot + 26, 64] },
                },
            },
            {
                className: 'Part',
                ...
                properties: {
                    Name: 'BranchB',
                    Size: [0.45, 1.9, 0.45],
                    Position: offsetPosition(pos, 1.2, 11.1, -0.9),
                    Color: [68, 46, 28],
                    Anchored: true,
                    Material: 'Wood',
                    Shape: 'Cylinder',
                    CFrame: { position: offsetPosition(pos, 1.2, 11.1, -0.9), rotation: [0, rot - 28, 66] },
                },
            },
        ],
        terrain: [],
        ...
        instances: [
            ...
            },
            {
                ...
                properties: {
                    Name: 'FoliageSkirt',
                    Size: [11, 2.4, 11],
                    Position: offsetPosition(pos, 0, 8.6, 0),
                    Color: [36, 98, 41],
                    Anchored: true,
                    Material: 'LeafyGrass',
                    Shape: 'Ball',
            ...
            },
            {
                ...
                properties: {
                    Name: 'FoliageConeMid',
                    Size: [6.4, 5.8, 6.4],
                    Position: offsetPosition(pos, 0, 14.8, 0),
                    Color: [30, 86, 35],
                    Anchored: true,
                    Material: 'LeafyGrass',
                    Shape: 'Block',
                    CFrame: { position: offsetPosition(pos, 0, 14.8, 0), rotation: [0, rot + 45, 0] },
                },
            },
        ],
        terrain: [],
        ...
        instances: [
            ...
            },
            {
                ...
                properties: {
                    Name: 'BookTray',
                    Size: [3.6, 0.15, 1.1],
                    Position: offsetPosition(pos, 0, 2.42, 0.45),
                    Color: [154, 156, 162],
                    Anchored: true,
                    Material: 'Metal',
                    CFrame: { position: offsetPosition(pos, 0, 2.42, 0.45), rotation: [0, rot, 0] },
                },
            },
            ...
            }))),
            {
                ...
                properties: {
                    Name: 'LowerBarFront',
                    Size: [4.8, 0.1, 0.1],
                    Position: offsetPosition(pos, 0, 0.52, 0.95),
                    Color: [142, 144, 150],
                    Anchored: true,
                    Material: 'Metal',
                    CFrame: { position: offsetPosition(pos, 0, 0.52, 0.95), rotation: [0, rot, 0] },
                },
            },
        ],
        terrain: [],
        ...
        instances: [
            ...
            }))),
            {
                ...
                properties: {
                    Name: 'ChairLowerBar',
                    Size: [1.7, 0.08, 0.08],
                    Position: offsetPosition(pos, 0, 0.42, 0.74),
                    Color: [126, 128, 134],
                    Anchored: true,
                    Material: 'Metal',
                    CFrame: { position: offsetPosition(pos, 0, 0.42, 0.74), rotation: [0, rot, 0] },
                },
            },
        ],
        terrain: [],
...
const TEMPLATE_REGISTRY = {
    deciduous_tree_small:  { fn: deciduousTreeSmall,  category: 'nature',       partCount: 5,  description: 'Small layered leafy tree with branch detail, ~12 studs tall',   footprintRadius: 4,  preferredSpacing: 12, placementTags: ['nature', 'tree', 'perimeter'] },
    deciduous_tree_medium: { fn: deciduousTreeMedium, category: 'nature',       partCount: 9,  description: 'Medium layered leafy tree with clustered canopy, ~20 studs',    footprintRadius: 5,  preferredSpacing: 16, placementTags: ['nature', 'tree', 'perimeter'] },
    pine_tree:             { fn: pineTree,            category: 'nature',       partCount: 6,  description: 'Layered pine tree with fuller lower foliage, ~19 studs tall',    footprintRadius: 5,  preferredSpacing: 16, placementTags: ['nature', 'tree', 'perimeter'] },
    ...
    desk:                  { fn: desk,                category: 'furniture',    partCount: 8,  description: 'School desk with tray, laminate top, and metal frame', footprintRadius: 3,  preferredSpacing: 7,  placementTags: ['furniture', 'interior', 'grid'] },
    chair:                 { fn: chair,               category: 'furniture',    partCount: 7,  description: 'Student chair with metal lower brace and fabric seat',  footprintRadius: 2,  preferredSpacing: 5,  placementTags: ['furniture', 'interior', 'grid'] },
